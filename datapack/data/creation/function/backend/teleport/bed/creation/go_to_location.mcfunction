$execute in $(dimension) positioned $(x) $(y) $(z) unless entity @s[tag=cr.tag.ForceloadedCreationChunk] store success score @s cr.check.PermanentChunk run forceload query ~ ~
